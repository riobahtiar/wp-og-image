...
class AdminOptions {
	...
	public function wp_og_image_create_admin_page() {
		...
		Helper\load_view( 'og-image-options',true,  array(
...
<!--		</div>-->
	...
	public function active_by_default_0_callback() {
		...
		<label for="active_by_default_0-1"><input type="radio" name="wp_og_image_option_name[active_by_default_0]" id="active_by_default_0-1" value="no" <?php echo $checked; ?>> No</label></fieldset> <?php
	}
